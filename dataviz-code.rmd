...
#Limiting data to 10 countries and for years between 2010 and 2019.
...
#Creating Plot 3: Gap b/w EoDB and CPI scores across differnt countries.
  ...
  ggplot(df_3_joined) +
    ...
    labs(x = "Index values",
         y = "Countries",
         caption = "Source:The Quality of Government Standard Dataset(2020).",
         title = "Lower values of Ease of Doing Business Scores usually follows countries with bad corruption practices.",
